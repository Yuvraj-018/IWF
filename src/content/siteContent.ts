  ...
  focusAreas: [
    {
      ...
      text: "Quality schooling, school kits, scholarships, community centres, and technical vocational training.",
    ...
    },
    {
      ...
      text: "Emergency life support, rural ambulances, patient financial aid, medical camps, and wellness clinics.",
    ...
    },
    {
      ...
      text: "Vocational skills, Self-Help Groups (SHGs), rights literacy, and youth enterprise incubation.",
      image: causeWomenImg,
      icon: Users,
    ...
    },
    {
      ...
      text: "Hands-on vocational trades, employability training, rural enterprise, and micro-business guidance.",
    ...
    },
    {
      ...
      text: "Constitutional rights education, legal aid camps, lawful judicial remedies, and grievance accountability.",
      image: sectorWomen1,
      icon: Scale,
    ...
    },
    {
      ...
      text: "Sustainable agriculture, farmer training, organic farming promotion, and income diversification.",
    ...
    },
    {
      ...
      text: "Environmental literacy, clean village initiatives, tree plantation drives, and rural ecological stewardship.",
    ...
    },
    {
      ...
      text: "Immediate disaster rescue, food packets, seasonal warmth, emergency shelter, and livelihood recovery.",
      image: sectorRelief1,
      icon: HandHeart,
...
export const SECTOR_CONTENT: Record<SectorContent["slug"], SectorContent> = {
  education: {
    ...
    initiatives: [
      "Primary School (EPS)",
      "School Kit & Learning Support (SKLS)",
      "Community Learning Centre (CLC)",
      "Academic Pathways & Talent Development (APTD)",
      "Scholarships for Higher Education (SHE)",
      "Career Guidance & Mentorship (CGM)",
      "Technical & Vocational Education and Training (TVET)",
      "Knowledge, Research & Publication (KRP)",
    ],
    impact: [
