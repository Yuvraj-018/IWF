    ...
    <section className="relative min-h-[430px] flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 py-16 w-full">
        <nav className="flex items-center gap-2 text-xs text-white/60 mb-6 font-medium flex-wrap">
          ...
          <ChevronRight className="w-3 h-3" />
          <span className="text-white/80">Diabetes Prevention (DPLA)</span>
        </nav>
        ...
        <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 px-3.5 py-1.5 rounded-full mb-5">
          ...
          <span className="text-xs font-bold tracking-widest uppercase text-white/90">Initiative 05 • DPLA</span>
        </div>

        <h1 className="text-4xl md:text-5xl font-extrabold text-white leading-tight tracking-tight mb-5">
          Diabetes Prevention &amp;<br />
          <span className="text-brand-orange">Lifestyle Awareness (DPLA)</span>
        </h1>
    ...
    <section className="py-10 bg-slate-50 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        >
          ...
          Prev: Health Check-up Camps (CHC)
        </Link>
        <Link
        ...
        >
          Next: Menstrual Health & Hygiene (MHHS)
