...
const CATEGORIES: { id: SectorCategory; label: string; icon: any }[] = [
  ...
  { id: "women", label: "Women & Youth", icon: Users },
  { id: "skills", label: "Skills & Livelihoods", icon: Briefcase },
  { id: "social-justice", label: "Social Justice", icon: Scale },
  { id: "agriculture", label: "Agriculture", icon: Sprout },
  { id: "environment", label: "Environment", icon: TreePine },
  { id: "relief", label: "Humanitarian Relief", icon: HeartHandshake },
];
...
const GALLERY_ITEMS: GalleryItem[] = [
  ...
  },
  {
    ...
    sector: "skills",
    sectorLabel: "Skills & Livelihoods",
  ...
  },
  {
    ...
    sector: "environment",
    sectorLabel: "Environment & Sustainable Dev",
  ...
  },
  {
    ...
    sector: "relief",
    sectorLabel: "Humanitarian Relief",
