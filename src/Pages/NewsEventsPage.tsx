...
const ALL_NEWS: NewsItem[] = [
  {
    ...
    excerpt: "Islah's Healthcare team conducted a comprehensive free medical camp at Bathiya, Darbhanga, providing consultations, medicines, blood pressure/sugar screenings, and eye checkups to 200+ patients from 12 surrounding villages. The camp was attended by 6 specialist doctors and 15 volunteers.",
    img: "🏥",
  },
  {
    id: 2, featured: true,
  ...
  },
  {
    ...
    title: "Islah Annual Report 2024–25 Published — 50+ Villages, 5,000+ Beneficiaries",
    excerpt: "The Islah Annual Report 2024–25 is now available. It documents our work across education, healthcare, and livelihood programmes, reaching 50+ villages and directly impacting 5,000+ beneficiaries through 12 active programs.",
    img: "📊",
  },
  {
    id: 5,
    ...
    excerpt: "As part of our Cervical Cancer Prevention Programme, Islah organized awareness sessions in 8 villages of Darbhanga. Over 500 women were educated about screening, vaccination, and early detection. Free HPV screening was offered to all participants.",
    img: "🔬",
  },
  {
    id: 6,
    ...
    excerpt: "25 women from rural Darbhanga successfully completed Islah's 3-month tailoring training programme under the Tayyari Kal Ki campaign. Each graduate received a certificate, a sewing machine, and help connecting with local markets.",
    img: "✂️",
  },
  {
    id: 7,
    ...
    excerpt: "Islah's Rural Ambulance Service reached a significant milestone — 500 emergency responses since inception. The service operates 24/7 across 50+ villages and has saved hundreds of lives by ensuring timely medical evacuation in areas with no public transport.",
    img: "🚑",
  },
  {
    id: 8,
    ...
    title: "Islah Signs MoU with District Health Department, Darbhanga",
    excerpt: "Islah signed a Memorandum of Understanding with the District Health Department, Darbhanga to collaborate on maternal health, immunization drives, and tuberculosis awareness campaigns across 20 Gram Panchayats.",
    img: "🤝",
  },
  {
    id: 9,
    ...
    excerpt: "Islah organized a free diabetes screening camp at Manigachhi, with 300 participants undergoing blood sugar tests. Nutritionists provided personalized dietary guidance, and 42 pre-diabetic individuals were enrolled in a lifestyle modification programme.",
    img: "💉",
  },
  {
    id: 10,
    ...
    excerpt: "Under the Menstrual Hygiene Support Programme, Islah distributed 5,000 sanitary hygiene kits to adolescent girls in 30 rural schools across Darbhanga and Madhubani. The drive also included hygiene awareness sessions conducted by female health workers.",
    img: "🌸",
  },
  {
    id: 11,
    ...
    excerpt: "Islah inaugurated a new Community Learning Centre at Bathiya, equipped with 30 tablets, a projector, and a small library. The centre will provide digital literacy, tuition, and skill training to 100+ children and youth from the village and nearby hamlets.",
    img: "📚",
  },
  {
    id: 12,
    ...
    title: "Islah Annual Foundation Day — 8 Years of Transformation Celebrated",
    excerpt: "Islah celebrated its 8th Foundation Day on Republic Day with a community event in Darbhanga. The event honored 50 long-serving volunteers, felicitated scholarship recipients, and launched the 'Tayyari Kal Ki 2025' youth skills programme.",
    img: "🎉",
  },
];
        ...
        <div className="p-6">
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 flex items-center justify-between">
            ...
            <a href="/contact" className="text-xs font-bold text-brand-green hover:underline flex items-center gap-1">
              Contact Islah <ArrowRight className="w-3 h-3" />
            </a>
          </div>
        </div>
      </div>
